...
# LIBBUTANO is the main directory of butano library (https://github.com/GValienC:\Data\Projects\GameDev\Butano\butano-20.2.0).
...
# ROMTITLE is a uppercase ASCII, max 12 characters text string containing the output pong.
